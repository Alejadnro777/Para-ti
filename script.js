...
btnAbrir.addEventListener("click", () => {
  ...
  // Mover el botón cerrar a la derecha
  btnCerrar.classList.add("mover-cerrar");
});
...
btnCerrar.addEventListener("click", () => {
  ...
  // Regresar el botón cerrar a su posición original
  btnCerrar.classList.remove("mover-cerrar");
});